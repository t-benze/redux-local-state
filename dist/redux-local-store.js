(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("redux-local-store", [], factory);
	else if(typeof exports === 'object')
		exports["redux-local-store"] = factory();
	else
		root["redux-local-store"] = factory();
})(this, function() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__localStoreId__ = __webpack_require__(37);
/* harmony export (immutable) */ __webpack_exports__["a"] = connectLocal;
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
function getLocalStoreProps(store, localStoreId, localStoreConfig) {
    ...
    function localDispatch(action) {
        ...
        if (typeof action === "function") {
            ...
            return store.dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__actions__["a" /* dispatchLocalAction */])(localStoreId, action));
        }
    }
    ...
    return _extends({}, modifiedMapDispatchToProps, {
        localStoreId: localStoreId
    });
}

function connectLocal(mapStateToProps, mapDispatchToProps, mergeProps, localStoreConfig, connectOptions = {}) {
    ...
    function modifiedMapStateToProps(state, props) {
        ...
        return _extends({}, globalStateProps, localStateProps);
    };

    const { storeKey = 'store', getDisplayName = name => `ConnectLocal${name}` } = connectOptions;
    const contextTypes = {
        [storeKey]: __WEBPACK_IMPORTED_MODULE_0_react__["PropTypes"].object
    };

    return function wrapWithLocalConnect(WrappedComponent) {
        __WEBPACK_IMPORTED_MODULE_2_invariant___default()(typeof WrappedComponent == 'function', `You must pass a component to the function returned by ` + `connectLocal. Instead received ${JSON.stringify(WrappedComponent)}`);

        const wrappedComponentName = WrappedComponent.displayName || WrappedComponent.name || 'Component';

        const displayName = getDisplayName(wrappedComponentName);

        const ConnectedComponent = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_redux__["a" /* connect */])(modifiedMapStateToProps, mapDispatchToProps, mergeProps, connectOptions)(wrappedComponent);

        class LocalConnect extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
            constructor(props, context) {
                super(props);
                this.state = {
                    isLocalStoreReady: false
                };
                this.localStoreId = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__localStoreId__["a" /* default */])();
                this.store = props[storeKey] || context[storeKey];

                __WEBPACK_IMPORTED_MODULE_2_invariant___default()(this.store, `Could not find "${storeKey}" in either the context or props of ` + `"${displayName}". Either wrap the root component in a <Provider>, ` + `or explicitly pass "${storeKey}" as a prop to "${displayName}".`);
            ...
            componentWillMount() {
                this.store.dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__actions__["b" /* registerLocalStore */])(this.localStoreId, localStoreConfig.reducer));
            }

            componentWillUnmount() {
                setTimeout(() => {
                    this.store.dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__actions__["c" /* discardLocalStore */])(this.localStoreId));
                });
            }

            render() {
                if (this.state.isLocalStoreReady) {
                    return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react__["createElement"])(ConnectedComponent, getLocalStoreProps(this.store, this.localStoreId, localStoreConfig));
                } else {
                    return null;
                }
            }
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = registerLocalStore;
/* harmony export (immutable) */ __webpack_exports__["c"] = discardLocalStore;
/* harmony export (immutable) */ __webpack_exports__["a"] = dispatchLocalAction;
/**
...
const LOCAL_REGISTER_STORE = '$LOCAL_REGISTER_STORE';
/* unused harmony export LOCAL_REGISTER_STORE */

const LOCAL_DISCARD_STORE = '$LOCAL_DISCARD_STORE';
/* unused harmony export LOCAL_DISCARD_STORE */

const LOCAL_DISPATCH_ACTION = '$LOCAL_DISPATCH_ACTION';
/* unused harmony export LOCAL_DISPATCH_ACTION */


function registerLocalStore(id, reducer) {
    return {
...
function dispatchLocalAction(id, localAction) {
    return {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__connectLocal__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__reducer__ = __webpack_require__(34);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "connectLocal", function() { return __WEBPACK_IMPORTED_MODULE_0__connectLocal__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "localReducer", function() { return __WEBPACK_IMPORTED_MODULE_1__reducer__["a"]; });
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(56);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(32), __webpack_require__(80)(module)))
...
//# sourceMappingURL=redux-local-store.js.map